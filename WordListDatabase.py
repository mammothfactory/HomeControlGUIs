...
class WordListDatabase:
    ...
    def __init__(self):
        ...
        self.obj = sqlitewrapper.SqliteCipher(dataBasePath="wordList.db" , checkSameThread=False , password="encryptedPassword")
...
if __name__ == "__main__":
    ...
    db.obj.insertIntoTable("encrytedUsersTable" , ["blaze.d.a.sanders@gmail.com", "Password", "Salt"], commit = True)
